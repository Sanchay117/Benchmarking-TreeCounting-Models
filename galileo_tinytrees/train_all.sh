...
# Optional CLI arguments to override
TARGET_MODEL=${1:-"all"}
TARGET_RATIO=${2:-"all"}
TARGET_SENSOR=${3:-"all"}

echo "==========================================================="
echo "   Galileo Foundation Model Fine-Tuning Pipeline           "
echo "==========================================================="
...
echo "==========================================================="
echo "All requested Galileo training runs completed successfully!"
echo "==========================================================="
