...
def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tune MCNN on KCL London dataset")
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional MCNN checkpoint (.pth/.pt or legacy .h5 from crowdcount-mcnn)",
    )
    parser.add_argument("--save-dir", type=str, default="ckpts/mcnn_kcl", help="Checkpoint output directory")
